...
if($pro_ffplay -eq 'ffplay')
{
    ...
    # 4. check picture similarity, if degree<0.7, kill ffplay.exe process, PASS
...
# if MpCmdRun.exe process exist, kill, PASS
# if not exist, and $s[-1] = 'Scan finished.', PASS
# else FAIL
